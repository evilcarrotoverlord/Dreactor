...
-auto8k targets 8000°C (with a saftey trottle if it reaches 16 satturation)
-if it detects a meltdown it should output a redstone signal to the top
-change the shield strenght by clicking the shieldbar at the spot you want to target
